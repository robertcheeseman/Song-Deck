...
export default function Search() {
  ...
  const secretID = 'YOUR SPOTIFY SECRET ID GOES HERE'
  ...
  // Save Song data to user's firestore database
      ...
      <div name="nav-container" id="nav-container">
        ...
        <div id="nav-content">
          <div className="nav-link nav-link-left">
            ...
            <Link className="nav-button-name-left" to="/Search"><img src="/images/objects/search.png" className="nav-button-img" alt="" onClick={stopSong}/></Link>
            <img src="/images/objects/corner button 2.png" className="nav-button-img nav-button-img-left" alt="" />
            <Link className="nav-button-name-left" to="/Songs"><img src="/images/objects/songs.png" className="nav-button-img" alt="" onClick={stopSong}/></Link>
          </div>
          <div className="nav-logo">
            <img src="/images/logo.png" id="logo" alt="" />
          </div>
          <div className="nav-link nav-link-right">
            <Link className="nav-button-name-right" to="/FAQ"><img src="/images/objects/faq.png" className="nav-button-img" alt="" onClick={stopSong}/></Link>
            <img src="/images/objects/corner button.png" className="nav-button-img nav-button-img-right" alt="" />
            <img src="/images/objects/logout.png" className="nav-button-img nav-button-name-right" alt="" id="logout" onClick={stopAndLogout} />
            <img src="/images/objects/corner button.png" className="nav-button-img nav-button-img-right" alt="" />
          </div>
        </div>
      </div>
