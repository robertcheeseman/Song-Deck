...
import { collection, addDoc, getDocs, setDoc, query, where, deleteDoc, doc } from "firebase/firestore";
            ...
            <div name="nav-container" id="nav-container">
                ...
                <div id="nav-content">
                    <div className="nav-link nav-link-left">
                        ...
                        <Link className="nav-button-name-left" to="/Search"><img src="/images/objects/search.png" className="nav-button-img" alt="" /></Link>
                        <img src="/images/objects/corner button 2.png" className="nav-button-img nav-button-img-left" alt="" />
                        <Link className="nav-button-name-left" to="/Songs"><img src="/images/objects/songs.png" className="nav-button-img" alt="" /></Link>
                    </div>
                    <div className="nav-logo">
                        <img src="/images/logo.png" id="logo" alt="" />
                    </div>
                    <div className="nav-link nav-link-right">
                        <Link className="nav-button-name-right" to="/FAQ"><img src="/images/objects/faq.png" className="nav-button-img" alt="" /></Link>
